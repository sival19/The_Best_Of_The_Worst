...
public class opretProgramController implements Initializable {
    ...
    public TextField dayField, monthField, yrField, lengthField;
    ...
    public String opretProgram(String programnavn, String yr, String mth, String day, String programtype, String genre, double længde){
       return creditsManagementSystem.opretProgram(programnavn,yr,mth,day, programtype,genre, længde);
    }

    public void opretProgramHandler(ActionEvent actionEvent) {

        resultatTxt.setText(opretProgram(programnavnField.getText(),yrField.getText(), monthField.getText(),dayField.getText(),
